...
//listen to when something is typed into the textarea
textArea.addEventListener('input', function() {
    ...
    var charAt = textArea.value.length - 1;

    // make textarea max character length to the length of the gettysburg string
    textArea.setAttribute('maxlength', gettysburg.length);
